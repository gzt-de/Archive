#!/usr/bin/python3
#
# this scans the standard registers on BMS ECU 0x07 and VCU ECU 0x16.  The BMS acts up if queried too fast or too many variables...
#
...
verbose=0   # don't filter realtime update packets, include verbose BLE output
debug=0     # show extended protocols
...
fuzAdr = 0x50    # start addr of scanning
